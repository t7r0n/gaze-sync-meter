...
- Local CLI and JSONL tool loop for `mirage-bench`.
...
This is a local prototype, not a production integration with Captions / Mirage. A production version would need authentication, tenant isolation, rate limits, formal privacy review, logging policy, and validation against private ground truth.
